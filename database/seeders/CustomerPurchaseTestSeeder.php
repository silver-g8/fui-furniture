...
class CustomerPurchaseTestSeeder extends Seeder
{
     ...
     *
     * This seeder is used to create sample sales orders and items
     * so that the "สินค้าที่เคยซื้อ" (purchased products) tab
     * on the customer detail page has data to display.
     */
